...
struct NetworkManager {
    ...
    func fetchResponse <EndPoint: EndPointType,ResponseType: Codable>(forEndPoint endPoint: EndPoint, completion: @escaping (_ response: ResponseType?,_ error: String?)->()){
